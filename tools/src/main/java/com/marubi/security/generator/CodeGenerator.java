package com.marubi.security.generator;
...
//        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/starter?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setModuleName(scanner("模块名 package name"));
        pc.setParent("com.marubi.security");
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initTableMap(TableInfo tableInfo) {
                /*tableInfo.setEntityName(tableInfo.getEntityName().substring(1)+"Entity");*/
                tableInfo.setServiceName(tableInfo.getServiceName().replaceFirst("Entity",""));
                tableInfo.setServiceImplName(tableInfo.getServiceImplName().replaceFirst("Entity",""));
                tableInfo.setMapperName(tableInfo.getMapperName().replaceFirst("Entity",""));
            }
        };
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/admin-core"+"/src/main/resources/mapper/"
